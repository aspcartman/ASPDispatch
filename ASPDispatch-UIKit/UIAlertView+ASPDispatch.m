...
#pragma clang diagnostic pop
	...
	{
		return [UIAlertController asp_showWithStyle:UIAlertControllerStyleAlert fromView:nil title:title message:message cancelButton:cancel otherButtons:other];
	}
}
@end